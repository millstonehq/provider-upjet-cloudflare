// Package v1beta1 contains the ProviderConfig type for the Cloudflare provider.
package v1beta1
...
type ProviderConfigSpec struct {
	// Credentials required to authenticate to Cloudflare API.
	// +kubebuilder:validation:Required
	Credentials ProviderCredentials `json:"credentials"`
}

// ProviderCredentials contains credentials for authenticating to Cloudflare.
